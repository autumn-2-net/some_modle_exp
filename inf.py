...
def predict(spectrogram=None, model_dir=None, params=None, device=torch.device('cuda'), fast_sampling=False):
  ...
  if not model_dir in models:
    ...
    model = PL_diffwav(params=base_params).load_from_checkpoint(r"./default/version_51/checkpoints/epoch=14-step=158228.ckpt",params=base_params)
    model=model
...
if __name__ == '__main__':
  ...
  # parser.add_argument('--spectrogram_path', '-s', default='./t/未命名 3.wav.spec.npy',
  #                     help='path to a spectrogram file generated by diffwave.preprocess')
  ...
  parser.add_argument('--output', '-o', default='./o/凯尔特史诗配乐Vindsvept Ep.2 _2022.7.14更新12P_-p31-A Voice in the Wind-16_converted.wav.spec.npy.wav.wav',
