...
def predict(spectrogram=None, model_dir=None, params=None, device=torch.device('cuda'), fast_sampling=False):
  ...
  if not model_dir in models:
    if os.path.exists(f'{model_dir}/ccc.cpt'):
      checkpoint = torch.load(f'{model_dir}/ccc.cpt')
      print(checkpoint)
    else:
...
if __name__ == '__main__':
  ...
  parser.add_argument('--spectrogram_path', '-s',default='./testwav/wav/SSB0009/SSB00090001.wav.spec.npy',
