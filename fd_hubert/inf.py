...
from fd.params import params as base_params
from diffwave.params import  params as sss
#from diffwave.model import DiffWave
from PL_FD_modle import PL_diffwav
...
def predict(spectrogram=None, model_dir=None, params=None, device=torch.device('cuda'), fast_sampling=False):
  ...
  model = PL_diffwav(params=base_params).load_from_checkpoint(
      r"./mdscp/sample-mnist-epoch19-19-53148.ckpt", params=base_params)
...
if __name__ == '__main__':
 ...
 #  dddd = torch.load(r'C:\Users\autumn\Desktop\poject_all\vcoder\t\未命名 4.wav.spec.npy')
  ...
  #                     help='path to a spectrogram file generated by diffwave.preprocess')
  parser.add_argument('--spectrogram_path', '-s', default=r'C:\Users\autumn\Desktop\poject_all\vcoder\t\未命名 4.wav.spec.npy',
                      help='path to a spectrogram file generated by diffwave.preprocess')
  # parser.add_argument('--spectrogram_path', '-s', default='./t/50.wav.spec.npy',
  #                     help='path to a spectrogram file generated by diffwave.preprocess')

  parser.add_argument('--output', '-o', default='./ssslp.wav',
